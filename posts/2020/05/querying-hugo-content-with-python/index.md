...
Is your query too awkward to comfortably type on a command line? Put it
...
I’m tempted to gut my Python workflow.
...
[PyYAML](https://pyyaml.org/) moves quick when powered by [libYAML](https://pyyaml.org/wiki/LibYAML).
